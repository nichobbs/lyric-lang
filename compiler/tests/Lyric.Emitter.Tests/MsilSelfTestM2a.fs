...
///
/// Compiles compiler/lyric/msil/msil_self_test_m2a.l via the Lyric emitter,
...
let private findSource () : string option =
    ...
    while found.IsNone && dir.IsSome do
        let candidate = Path.Combine(dir.Value.FullName, "lyric", "msil", "msil_self_test_m2a.l")
    ...
    testList "Msil.SelfTest M2a (heap builder structural checks)" [
        ...
        testCase "msil_self_test_m2a" <| fun () ->
            let src =
                ...
                | None      -> failwith "cannot locate compiler/lyric/msil/msil_self_test_m2a.l"
