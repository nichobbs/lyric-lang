...
///
/// Compiles compiler/lyric/msil/msil_self_test_m11.l, runs it (producing a
...
let private findSource () : string option =
    ...
    while found.IsNone && dir.IsSome do
        let candidate = Path.Combine(dir.Value.FullName, "lyric", "msil", "msil_self_test_m11.l")
    ...
    testList "Msil.SelfTest M11 (InterfaceImpl table)" [
        ...
        testCase "msil_self_test_m11" <| fun () ->
            let src =
                ...
                | None      -> failwith "cannot locate compiler/lyric/msil/msil_self_test_m11.l"
