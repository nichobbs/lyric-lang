...
///
/// Compiles compiler/lyric/jvm/self_test_b11.l, runs it (which generates
...
let private findSelfTestB11Source () : string option =
    ...
    while found.IsNone && dir.IsSome do
        let candidate = Path.Combine(dir.Value.FullName, "lyric", "jvm", "self_test_b11.l")
    ...
    testList "Jvm.Zip B11 (ZIP/JAR assembler)" [
        ...
        testCase "b11_jar_assembler_produces_valid_zip" <| fun () ->
            let src =
                ...
                | None      -> failwith "cannot locate compiler/lyric/jvm/self_test_b11.l"
