...
///
/// Compiles `compiler/lyric/lyric/fmt_self_test.l` via the bootstrap
...
/// `compiler/lyric/lyric/fmt/*.l` transparently.
    ...
    testList "Lyric.Fmt self-host (Phase 5 §M5.3 formatter port)" [
        ...
        testCase "[fmt_self_test_passes]" <| fun () ->
            let src =
                ...
                | None ->
                    failwith
                        "cannot locate compiler/lyric/lyric/fmt_self_test.l — run from the source tree"
