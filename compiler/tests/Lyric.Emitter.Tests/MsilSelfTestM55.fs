...
///
/// Compiles compiler/lyric/msil/msil_self_test_m55.l, runs it (PE zeroes a local
...
let tests =
    testList "Msil.SelfTest M55 (initobj)" [

        testCase "msil_self_test_m55" <| fun () ->
            let src =
                match findMsilSource "msil_self_test_m55.l" with
                | Some path -> File.ReadAllText path
                | None      -> failwith "cannot locate compiler/lyric/msil/msil_self_test_m55.l"
            ...
            let result, stdout, stderr, exitCode = compileAndRun "msil_self_test_m55" src
            ...
            for check in [ "dos_ok"; "pe_sig_ok"; "clr_cb_ok"; "entry_tok_ok"
                           ...
                           "initobj_prefix_ok"; "initobj_ok"; "bsjb_ok" ] do
