    ...
    testList "Jvm.Lowering B128 (@externTarget static call with Result wrapping)" [
        ...
        testCase "b128_extern_target_parse_ok_and_err" <| fun () ->
            let src =
                ...
                | None      -> failwith "cannot locate compiler/lyric/jvm/self_test_b128.l"

            let result, stdout, stderr, exitCode = compileAndRun "jvm_driver_b128" src
            ...
            let jarPath = "/tmp/lyric-jvm-b128/parse.jar"
