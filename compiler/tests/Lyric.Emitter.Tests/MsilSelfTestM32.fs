...
///
/// Compiles compiler/lyric/msil/msil_self_test_m32.l, runs it (PE zero-
...
let tests =
    testList "Msil.SelfTest M32 (initobj)" [

        testCase "msil_self_test_m32" <| fun () ->
            let src =
                match findMsilSource "msil_self_test_m32.l" with
                | Some path -> File.ReadAllText path
                | None      -> failwith "cannot locate compiler/lyric/msil/msil_self_test_m32.l"
            ...
            let result, stdout, stderr, exitCode = compileAndRun "msil_self_test_m32" src
            ...
            for check in [ "dos_ok"; "pe_sig_ok"; "clr_cb_ok"; "entry_tok_ok"
                           ...
                           "ldloca_ok"; "initobj_ok"; "initobj_tok_ok"; "bsjb_ok" ] do
