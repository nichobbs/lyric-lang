...
///
/// Compiles compiler/lyric/msil/msil_self_test_m27.l, runs it (PE boxes 42
...
module Lyric.Emitter.Tests.MsilSelfTestM27
...
let tests =
    testList "Msil.SelfTest M27 (callvirt)" [

        testCase "msil_self_test_m27" <| fun () ->
            let src =
                match findMsilSource "msil_self_test_m27.l" with
                | Some path -> File.ReadAllText path
                | None      -> failwith "cannot locate compiler/lyric/msil/msil_self_test_m27.l"
            ...
            let result, stdout, stderr, exitCode = compileAndRun "msil_self_test_m27" src
            ...
            for check in [ "dos_ok"; "pe_sig_ok"; "clr_cb_ok"; "entry_tok_ok"
                           "tiny_hdr_ok"; "box_ok"
                           "callvirt_ok"; "callvirt_tok_ok"; "bsjb_ok" ] do
