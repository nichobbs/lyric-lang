...
///
/// Compiles compiler/lyric/jvm/self_test_b3.l via the Lyric emitter,
    ...
    testList "Jvm.Lowering (stage B3)" [
        ...
        testCase "b3_lowering_emits_adder_and_point" <| fun () ->
            let src =
                ...
                | None      -> failwith "cannot locate compiler/lyric/jvm/self_test_b3.l — run from the source tree"
