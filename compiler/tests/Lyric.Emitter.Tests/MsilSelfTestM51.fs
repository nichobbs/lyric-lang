...
///
/// Compiles compiler/lyric/msil/msil_self_test_m51.l, runs it (PE locallocs 4
...
let tests =
    testList "Msil.SelfTest M51 (volatile.)" [

        testCase "msil_self_test_m51" <| fun () ->
            let src =
                match findMsilSource "msil_self_test_m51.l" with
                | Some path -> File.ReadAllText path
                | None      -> failwith "cannot locate compiler/lyric/msil/msil_self_test_m51.l"
            ...
            let result, stdout, stderr, exitCode = compileAndRun "msil_self_test_m51" src
            ...
            for check in [ "dos_ok"; "pe_sig_ok"; "clr_cb_ok"; "entry_tok_ok"
                           "fat_hdr_ok"; "local_sig_ok"; "volatile_prefix_ok"
                           "volatile_ok"; "bsjb_ok" ] do
