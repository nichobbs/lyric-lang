...
///
/// Compiles compiler/lyric/msil/msil_self_test_m26.l, runs it (PE creates a
...
let tests =
    testList "Msil.SelfTest M26 (newarr + ldelem + stelem)" [

        testCase "msil_self_test_m26" <| fun () ->
            let src =
                match findMsilSource "msil_self_test_m26.l" with
                | Some path -> File.ReadAllText path
                | None      -> failwith "cannot locate compiler/lyric/msil/msil_self_test_m26.l"
            ...
            let result, stdout, stderr, exitCode = compileAndRun "msil_self_test_m26" src
            ...
            for check in [ "dos_ok"; "pe_sig_ok"; "clr_cb_ok"; "entry_tok_ok"
                           ...
                           "newarr_ok"; "newarr_tok_ok"; "stelem_ok"; "ldelem_ok"
                           "bsjb_ok" ] do
