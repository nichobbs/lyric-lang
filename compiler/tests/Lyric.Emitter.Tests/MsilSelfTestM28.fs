...
///
/// Compiles compiler/lyric/msil/msil_self_test_m28.l, runs it (PE stores 20
...
let tests =
    testList "Msil.SelfTest M28 (ldsfld + stsfld)" [

        testCase "msil_self_test_m28" <| fun () ->
            let src =
                match findMsilSource "msil_self_test_m28.l" with
                | Some path -> File.ReadAllText path
                | None      -> failwith "cannot locate compiler/lyric/msil/msil_self_test_m28.l"
            ...
            let result, stdout, stderr, exitCode = compileAndRun "msil_self_test_m28" src
            ...
            for check in [ "dos_ok"; "pe_sig_ok"; "clr_cb_ok"; "entry_tok_ok"
                           "tiny_hdr_ok"
                           "stsfld_ok"; "stsfld_tok_ok"
                           "ldsfld_ok"; "ldsfld_tok_ok"
                           "bsjb_ok" ] do
