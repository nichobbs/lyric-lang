...
///
/// Compiles compiler/lyric/msil/msil_self_test_m53.l, runs it (PE computes
...
let tests =
    testList "Msil.SelfTest M53 (ceq+cgt+clt)" [

        testCase "msil_self_test_m53" <| fun () ->
            let src =
                match findMsilSource "msil_self_test_m53.l" with
                | Some path -> File.ReadAllText path
                | None      -> failwith "cannot locate compiler/lyric/msil/msil_self_test_m53.l"
            ...
            let result, stdout, stderr, exitCode = compileAndRun "msil_self_test_m53" src
            ...
            for check in [ "dos_ok"; "pe_sig_ok"; "clr_cb_ok"; "entry_tok_ok"
                           "tiny_hdr_ok"; "ceq_ok"; "cgt_ok"; "clt_ok"; "bsjb_ok" ] do
