...
///
/// Compiles compiler/lyric/msil/msil_self_test_m2c.l via the Lyric emitter,
...
let private findSource () : string option =
    ...
    while found.IsNone && dir.IsSome do
        let candidate = Path.Combine(dir.Value.FullName, "lyric", "msil", "msil_self_test_m2c.l")
    ...
    testList "Msil.SelfTest M2c (metadata table model)" [
        ...
        testCase "msil_self_test_m2c" <| fun () ->
            let src =
                ...
                | None      -> failwith "cannot locate compiler/lyric/msil/msil_self_test_m2c.l"
