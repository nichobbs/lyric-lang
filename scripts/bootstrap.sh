...
EOF
  ...
  # `Lyric.Mail.Host` was removed in #1054 — the lyric-mail SMTP backend
  # now uses typed externs directly (no F# shim).  The bundle copy step
  # was retained here for several PRs and broke stage-1 builds when the
  # F# project was deleted; the publish is now skipped.
