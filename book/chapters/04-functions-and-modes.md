...
Calling a function value checks its arguments just like a direct call, numeric widening included: passing an `Int` where the function takes a `Long` works, and the function receives a `Long`.
