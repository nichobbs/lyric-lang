 ...
 * German ß expansion) for Basic Latin, Latin-1 Supplement, Latin Extended-A,
 * Greek, and Cyrillic; every other code point passes through unchanged.
 * This is a real Unicode case fold across five scripts, not an ASCII-only
 * shim, but it is not the full Unicode Character Database — issue #6588's
 * follow-up tracks widening script coverage.
 *
