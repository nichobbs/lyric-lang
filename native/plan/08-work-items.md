...
### N9.8 — Fix `and`/`or` short-circuit ARC temp release crossing a non-dominating block (#6645, #6719, #6722) — ✅ SHIPPED (D-progress-896)
...
project's usual ASan self-test verification — see D-progress-896 for
