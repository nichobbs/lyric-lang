...
///
/// Compiles lyric-compiler/jvm/self_test_b5.l, runs it (which writes
...
let private findSelfTestB5Source () : string option =
    ...
    while found.IsNone && dir.IsSome do
        let candidate = Path.Combine(dir.Value.FullName, "lyric-compiler", "jvm", "self_test_b5.l")
    ...
    testList "Jvm.Lowering B5 (stack-map frames)" [
        ...
        testCase "b5_stackmap_makes_branching_class_jvm_loadable" <| fun () ->
            let src =
                ...
                | None      -> failwith "cannot locate lyric-compiler/jvm/self_test_b5.l"
