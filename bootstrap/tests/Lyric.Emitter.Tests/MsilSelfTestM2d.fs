...
///
/// Compiles lyric-compiler/msil/msil_self_test_m2d.l via the Lyric emitter,
...
let private findSource () : string option =
    ...
    while found.IsNone && dir.IsSome do
        let candidate = Path.Combine(dir.Value.FullName, "lyric-compiler", "msil", "msil_self_test_m2d.l")
    ...
    testList "Msil.SelfTest M2d (parameterized PE assembler)" [
        ...
        testCase "msil_self_test_m2d" <| fun () ->
            let src =
                ...
                | None      -> failwith "cannot locate lyric-compiler/msil/msil_self_test_m2d.l"
