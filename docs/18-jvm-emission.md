...
**Resolution (#3932, D-progress-908):** the JVM backend implements the D107
...
| Q-J010 | `@externTarget` `Option[T]` null-coercion (D107 Phase 2) | §24: **RESOLVED** — shipped in D-progress-908 (#3932) |
