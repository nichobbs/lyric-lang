...
| `F0027` | hint-less `@externTarget` whose calling convention could not be metadata-verified (error since D-progress-944; shipped as a warning in D-progress-671, promoted once the #7169 ecosystem audit found zero remaining occurrences) | `msil/codegen.l:23661` |
