...
| `F0027` | hint-less `@externTarget` whose calling convention could not be metadata-verified (error since D-progress-981, which also closed a NuGet-backed gap the #7169 audit missed; shipped as a warning in D-progress-671) | `msil/codegen.l:23766` |
