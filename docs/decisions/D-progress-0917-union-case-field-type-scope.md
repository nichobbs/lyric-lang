# D-progress-917 — Self-hosted compiler: union case field types now resolve under the case's OWN declaring package, closing the #6972 gap left by D-progress-915's record-only fix
...
**Related:** #6972 (this fix), D-progress-915/#6689 (the record-only
