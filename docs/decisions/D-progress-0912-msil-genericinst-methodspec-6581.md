# D-progress-912 — MSIL codegen: GENERICINST-shaped member params/returns on a generic-declaring type, and MethodSpec for a BCL method with its own generics, both now emit correctly (#6581)
