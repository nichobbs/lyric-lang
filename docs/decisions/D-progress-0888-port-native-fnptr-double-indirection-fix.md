# D-progress-888 — Port: native codegen destructor/closure/trampoline/vtable function-pointer bitcasts over-wrapped in an extra `NPtr` (#7030)
...
expected 'void (i8*)**'`. This PR's diff (`lyric-compiler/msil/codegen.l`,
an MSIL-only restored-closure fix) does not touch the native/LLVM
