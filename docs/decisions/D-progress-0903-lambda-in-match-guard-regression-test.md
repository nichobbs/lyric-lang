# D-progress-903 — MSIL codegen: confirmed a lambda literal in a match-arm guard no longer hits "lambda token missing"; added the missing runtime regression test (#6553)
