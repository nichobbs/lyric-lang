# D-progress-914 — #6537's two residual `externTypeNames` bare-name-collision sites confirmed already fixed by PR #6981; regression tests added
...
**Found already fixed.** PR #6981's Gap 1 work (D-progress-912) had
...
#6981/D-progress-912, tests added here), #6041/#6536 (the original bug
