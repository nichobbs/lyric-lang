# D-progress-920 — JVM codegen: narrow the P0051 gate from D-progress-919 to genuine reserved-keyword diagnostics only (review follow-up, #6953)

**Status:** shipped

**Context.** Automated review of D-progress-919's PR found that `code ==
...
advisory-diagnostics design (and D-progress-919's own "P0051 is never a false
