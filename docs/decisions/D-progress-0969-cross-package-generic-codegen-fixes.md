# D-progress-969 — Generic inference and MSIL fixes found by a cross-package UI example (#7250)
...
2. The checker records (a) the widened arguments of a direct call to another
   ...
   D-progress-964 desugar on every target, and (b) the result type of every
