# 47 — Import Extern Syntax for External Types (sketch)

**Status:** Unbacked sketch. Design tensions are unresolved; see §5 for the
...
**Decision-log entry:** to follow once tensions are resolved.
