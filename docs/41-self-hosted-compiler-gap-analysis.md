...
- **Band 2 (backend correctness, CRITICAL):** C3 (`?` no-op, #1475), all of
  ...
  **H20 (capturing closures)** is now PARTIAL (#1479): captures fail loudly
  ...
  callbacks run correctly through higher-order functions; parameter-using
  lambdas fail loud pending boxed-arg unboxing (#1939). Lambdas in a
