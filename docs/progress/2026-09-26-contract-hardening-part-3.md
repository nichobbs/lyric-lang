...
- **Labelled loops** (D-progress-989, #7349). `label: for|while|do` with
...
- **Contract clauses** (D-progress-991, D-progress-986, #7228).
...
- **Loop invariants** (D-progress-984, #7224). Checked on normal loop exit,
...
- **Integers** (D-progress-985, #7346, #7350, #7382).
...
- **MSIL literal `val`s** (D-progress-990, #7403). A literal `pub val` read
...
- **Stdlib** (D-progress-983, #7251, #7401).
