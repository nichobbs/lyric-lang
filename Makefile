...
# The set of lyric-compiler/lyric/*_self_test.l files empirically verified
# (not just cross-referenced against ci.yml — that approach produced two
# incomplete lists in a row, #5296/#5297) to pass under a plain `./bin/lyric
# test --target dotnet <file>`.  Generated by running every file in the
# directory individually against a from-scratch `make lyric` build and
# keeping the ones that passed; regenerate the same way if this drifts:
...
TEST_EMITTER_FILES := \
	...
	lyric-compiler/lyric/aspect_weave_self_test.l \
	lyric-compiler/lyric/async_extern_self_test.l \
	lyric-compiler/lyric/async_generator_self_test.l \
	lyric-compiler/lyric/async_sm_self_test.l \
	lyric-compiler/lyric/async_spawn_self_test.l \
	lyric-compiler/lyric/auto_ffi_self_test.l \
	lyric-compiler/lyric/bitwise_self_test.l \
	...
	lyric-compiler/lyric/conv_methods_self_test.l \
	lyric-compiler/lyric/cross_package_generics_self_test.l \
	...
	lyric-compiler/lyric/for_loop_slice_self_test.l \
	...
	lyric-compiler/lyric/generic_slice_self_test.l \
	...
	lyric-compiler/lyric/loop_eh_collection_self_test.l \
	lyric-compiler/lyric/loop_invariant_self_test.l \
	lyric-compiler/lyric/manifest_self_test.l \
	lyric-compiler/lyric/map_enhancements_self_test.l \
...
test-emitter: lyric ## Run the empirically-verified --target dotnet, no-special-env self-test set (see the list comment above for exclusions)
	@status=0; \
